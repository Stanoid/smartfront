...
const NumberInput: React.FC<NumberInputProps> = ({
  ...
  return (
    <div>
      <div className="flex space-x-2 " style={{fontSize:10,justifyContent:"center",alignItems:"center"}}>
        <DebouncedInput
          type="number"
          min={min}
          max={max}
          ...
          style={{borderBottom:" 2px solid  #6B617C"}}
  ...
  return (
    <React.Fragment>
      ...
      <DebouncedInput
        ...
        style={{borderBottom:" 2px solid  #6B617C",fontSize:10}}
        list={dataListId}
      />
      <div className="h-1" />
    </React.Fragment>
